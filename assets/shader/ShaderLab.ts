       ...
       frag:`
        ...
        {   vec2 uv = uv0.xy;
            ...
            if (uv0.x < offset_min) {
                if (uv0.y < offset_min) {
                    // 左下
                    x = abs(uv0.x - offset_min);
                    y = abs(uv0.y - offset_min);
                }else if(uv0.y > offset_max){
                    //左上
                    x = abs(uv0.x - offset_min);
                    y = abs(uv0.y - offset_max);
                }else{
                    //中右
                    x = abs(uv0.x - offset_min);
                }
            }else if(uv0.x > offset_max){
                if (uv0.y < offset_min) {
                    //右下
                    x = abs(uv0.x - offset_max);
                    y = abs(uv0.y - offset_min);
                }else if(uv0.y > offset_max){
                    //右上
                    x = abs(uv0.x - offset_max);
